...
CREATE POLICY "Users can update own profile." ON "public"."profiles" FOR UPDATE USING (("auth"."uid"() = "id")) WITH CHECK (true);
...
CREATE POLICY "user can update there profile" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
